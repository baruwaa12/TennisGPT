...
class AddMatchScreen extends StatefulWidget {
  ...
  final DateTime? existingMatchDate;
...
class _AddMatchScreenState extends State<AddMatchScreen> {
  ...
  final TextEditingController _opponentLevelSeedController =
  ...
  final TextEditingController _tacticalNotesController =
      TextEditingController();
  ...
  void initState() {
    ...
    if (widget.initialOpponentName != null &&
        widget.initialOpponentName!.isNotEmpty) {
      _opponentController.text = widget.initialOpponentName!;
    }
    if (widget.initialScoreLine != null &&
        widget.initialScoreLine!.isNotEmpty) {
      _scoreController.text = widget.initialScoreLine!;
    }
    if (widget.initialOpponentLevelSeed != null &&
        widget.initialOpponentLevelSeed!.isNotEmpty) {
  ...
  Future<void> _saveMatch() async {
    ...
    final scoreError =
        MatchScoreValidator.validate(_matchFormat, _scoreController.text);
    if (scoreError != null) {
      setState(() {
    ...
    try {
      final String matchId = widget.existingMatchId ??
          DateTime.now().millisecondsSinceEpoch.toString();
      final DateTime matchDate = widget.existingMatchDate ?? DateTime.now();
      ...
      final parsedScore =
          MatchScoreValidator.parse(_matchFormat, _scoreController.text);
      final result =
          parsedScore.setsWon > parsedScore.setsLost ? 'Win' : 'Loss';
